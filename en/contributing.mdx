...
Welcome to OpenYiDA!'re excited you're interested in contributing. This guide covers everything you need to get started.
...
| Name | Role | GitHub |
|------|------|--------|
| **九神 (yize)** | Core architecture, CLI design | [@yize](https://github.com/yize) |
| **alex-mm** | Feature development, testing | [@alex-mm](https://github.com/alex-mm) |
| **nicky1108** | OpenClaw integration, skill extensions | [@nicky1108](https://github.com/nicky1108) |
...
## AI / Vibe-Coded PRs Welcome!PRs assisted by Claude Code, Cursor, Aone Copilot, or any other AI tool are fully welcome! Please mention which AI tool you used in the PR description — it helps maintainers understand the generation context.
