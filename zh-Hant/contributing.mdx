---
title: "貢獻指南"
description: "如何為 OpenYiDA 做出貢獻 — 錯誤報告、功能、文件和技能。"
icon: "handshake"
---
...
| 名稱 | 角色 | GitHub |
|------|------|--------|
| **九神 (yize)** | 核心架構、CLI 設計 | [@yize](https://github.com/yize) |
| **alex-mm** | 功能開發、測試 | [@alex-mm](https://github.com/alex-mm) |
| **nicky1108** | OpenClaw 整合、技能擴充 | [@nicky1108](https://github.com/nicky1108) |
...
## 歡迎 AI / Vibe-Coded PR！完全歡迎由 Claude Code、Cursor、Aone Copilot 或任何其他 AI 工具輔助的 PR！請於 PR 描述中註明您使用的 AI 工具 — 這有助於維護者理解生成背景。
