...
| 名称 | 角色 | GitHub |
|------|------|--------|
| **九神 (yize)** | 核心架构、CLI 设计 | [@yize](https://github.com/yize) |
| **alex-mm** | 功能开发、测试 | [@alex-mm](https://github.com/alex-mm) |
| **nicky1108** | OpenClaw 集成、技能扩展 | [@nicky1108](https://github.com/nicky1108) |
